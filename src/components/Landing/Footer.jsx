...
const links = {
  Product:  ['Globe View', 'Analytics', 'API Access', 'Integrations', 'Changelog'],
    ...
    <footer className={styles.footer} id="footer" role="contentinfo">
      <div className="container">
          ...
          <div className={styles.brand}>
            <a href="#" className={styles.logo} aria-label="Orbis home">
              <svg width="24" height="24" viewBox="0 0 100 100" fill="none" aria-hidden="true">
                <circle cx="50" cy="50" r="44" stroke="#4d9fff" strokeWidth="4"/>
                <ellipse cx="50" cy="50" rx="20" ry="44" stroke="#4d9fff" strokeWidth="2.5" opacity="0.7"/>
                <line x1="6" y1="50" x2="94" y2="50" stroke="#4d9fff" strokeWidth="2.5" opacity="0.7"/>
              </svg>
              <span className={styles.logoText}>Orbis</span>
            </a>
            <p className={styles.tagline}>
              Real-time Earth intelligence for the teams who shape the future.
            </p>
        ...
        <div className={styles.bottom}>
          <p className={styles.copy}>© 2026 Orbis Technologies, Inc. All rights reserved.</p>
